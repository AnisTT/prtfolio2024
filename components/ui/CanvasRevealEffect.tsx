...
type Uniforms = {
  [key: string]: {
    value: number | number[] | THREE.Vector2 | THREE.Vector3 | THREE.Vector2[] | THREE.Vector3[];
    type: string;
  };
};
...
const ShaderMaterial = ({
  ...
  const getUniforms = (uniforms: { [key: string]: Uniform }): { [key: string]: PreparedUniform } => {
    const preparedUniforms: { [key: string]: PreparedUniform } = {};
...
interface ShaderProps {
  ...
  uniforms: {
    [key: string]: {
      value: number[] | number[][] | THREE.Vector3[] | number;
      type: string;
    };
  };
  maxFps?: number;
